...
const sidebarOptions = {
  ...
  subscriptions: [
    ...
    {
      img: "",
      name: "Bernardo Faria BJJ Fanatics",
    },
  ],
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-4 py-2 px-4 sticky bg-white top-0 left-0 w-full">
        <button
          className="sidebar-button p-2 flex rounded-4xl active:bg-gray-tag-hover-bg"
      ...
      <div className="sidebar-sections">
        {/* SECTION: Guides */}
        <div className="guides py-2 px-4 border-b-1 border-b-gray-200">
          {/* Visible */}
          <div className="visible-guides">
            {sidebarOptions.guides.visible.map((item) => (
              <SidebarButton>
                {item.icon}
          ...
          {/* Collapsible */}
          <div className="collapsible-guides border-t-1 border-gray-200 mt-4 pt-4">
            <SidebarButton
              classes="gap-2 active:bg-gray-tag-hover-bg"
              styles={{ columnGap: "0.5rem" }}
            >
              <span className="font-semibold">You</span>
              <GoChevronRight size={24} />
            </SidebarButton>

            {sidebarOptions.guides.collapsible.map((item) => (
              <SidebarButton>
                {item.icon}
                <span className="text-sm">{item.title}</span>
              </SidebarButton>
        ...
        <div className="subscriptions py-4 pl-4 border-b-1 border-b-gray-200">
          <h4 className="font-semibold mb-2">Subscriptions</h4>
          <div className="subs-list">
            {sidebarOptions.subscriptions.map((item) => (
              <button className="flex justify-start items-center gap-6 w-full p-2 rounded-xl hover:bg-gray-tag-bg active:bg-gray-tag-hover-bg">
                <RxAvatar size={24} />
            ...
            <button className="flex items-center gap-6 w-full p-2 rounded-xl hover:bg-gray-tag-bg active:bg-gray-tag-hover-bg">
        ...
        {/* SECTION: Explore */}
        <div className="explore py-4 px-4 border-b-1 border-gray-200">
          <h4 className="font-semibold mb-2">Explore</h4>

          {sidebarOptions.explore.map((item) => (
            <SidebarButton>
              {item.icon}
              <span className="text-sm">{item.title}</span>
            </SidebarButton>
        ...
        <div className="explore py-4 px-4 border-b-1 border-gray-200">
          <h4 className="font-semibold mb-2">More from YouTube</h4>

          {sidebarOptions.more.map((item) => (
            <SidebarButton>
              {item.icon}
              <span className="text-sm">{item.title}</span>
            </SidebarButton>
        ...
        {/* SECTION: Settings */}
        <div className="explore py-4 px-4 border-b-1 border-gray-200">
          {sidebarOptions.settings.map((item) => (
            <SidebarButton>
              {item.icon}
              <span className="text-sm">{item.title}</span>
            </SidebarButton>
        ...
        <div className="explore py-4 px-4">
          <ul className="flex flex-wrap gap-2">
            {sidebarOptions.footer.group1.map((item, index) => (
              <li className="text-xs/3 font-bold text-[#606060] " key={index}>
                {item}
              </li>
            ))}
          </ul>
          ...
          <ul className="flex flex-wrap gap-2 mt-6">
            {sidebarOptions.footer.group2.map((item, index) => (
              <li className="text-xs/3 font-bold text-[#606060] " key={index}>
                {item}
              </li>
            ))}
          ...
          <p className="mt-8 text-xs text-[#909090]">© 2025 Google LLC</p>
        </div>
      </div>
    </div>
  );
